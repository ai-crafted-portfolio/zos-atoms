...
- データセットの編成と RECFM — [ZOS-DATASET-001](zos-dataset-001.md)
- JCL の DD 連結 — [ZOS-JCL-001](zos-jcl-001.md)
...
- `used_by`: [ZOS-GDG-001](zos-gdg-001.md)（全世代 concatenation の集計）, [ZOS-JCL-001](zos-jcl-001.md)（IEBGENER 代替）, [ZOS-SMF-001](zos-smf-001.md)（SMF dump 集計の前処理）
