...
- `used_by`: ZOS-WLM-001 (type 70/72), ZOS-RACF-001 (type 80 出力), ZOS-DB2-001 (type 101 出力), ZOS-DUMP-001 (type 99 ロジレックレコード)
...
市販書籍 (BK_MF_001, BK_ZOS_TECH_001/002) から SMF レコード分析の運用知識を概念蒸留 (ADR-0109)。逐語引用禁止。
